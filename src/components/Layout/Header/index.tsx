...
const Header: React.FC = () => {
  ...
  return (
    <header className={`fixed h-24 py-1 z-50 w-full bg-white transition-all duration-300 lg:px-0 px-4 ${sticky ? "top-3" : "top-0"}`}>
      <nav className={`container mx-auto max-w-8xl flex items-center justify-between py-4 duration-300 ${sticky ? "shadow-lgtop-5 px-4 " : "shadow-none top-0"}`}>
